...
fn main() {
	...
	// Listing 8-22: Showing that keys and values are owned by the hash map once they're insrted
	let field_name = String::from("Favorite color") ;
	let field_value = String::from("Blue") ;

	let mut map = HashMap::new() ;
	map.insert(field_name, field_value) ;
	// field_name and field_value are invalid at this point, try using them and see what the compiler error you get!
	...
	// Listing 8-24: Replacing a vlue stored with a paricular key
	let mut scores = HashMap::new() ;
